...
class MobileProfileImageUploadScreen extends StatefulWidget {
  const MobileProfileImageUploadScreen({super.key});

  @override
  State<MobileProfileImageUploadScreen> createState() =>
      _MobileProfileImageUploadScreenState();
}

class _MobileProfileImageUploadScreenState
    extends State<MobileProfileImageUploadScreen> {
