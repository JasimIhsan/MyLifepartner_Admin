import { PrismaClient, SwipeAction, Role, ProfileStatus, Gender, MaritalStatus, LookingFor, EmotionalReadiness, ChildrenStatus, RelationshipTimeline, SmokingHabit, DrinkingHabit, SelfieStatus } from "@prisma/client";
